package com.ebazar.microservices.api_gateway.routes;
...
/**
 * Routing rules for the API Gateway...
 * use gateway service to access other service (use localhost:8090/api/product-service/products) instead of localhost:8080/products
 */
@Configuration
public class Routes {
    ...
    /**
     * Functional Endpoints for the API Gateway
    ...
    /**
     * Route localhost:9000/aggregate/product-service/v3/api-docs to localhost:8080/api-docs
     * call  localhost:9000/aggregate/product-service/v3/api-docs
     * @return
     */
    ...
    /**
     * Fallback route for circuit breaker filter. (if circuit breaker is open --> forward to fallback route)
     * @return
     */
    @Bean
